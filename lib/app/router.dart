...
//import '../../features/schedules/presentation/schedules_home_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // Profile & Settings (Profile was missing before)
      ...
      // Schedules home (placeholder)
      //GoRoute(path: '/schedules', builder: (context, state) => const SchedulesHomeScreen()),
    ],
  );
});
